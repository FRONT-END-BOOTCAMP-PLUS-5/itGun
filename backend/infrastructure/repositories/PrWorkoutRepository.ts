    ...
    try {
      const updatedWorkout = await prisma.workout.update({
        ...
        data: {
          ...
          ...(workoutData.exerciseName && { exerciseName: workoutData.exerciseName }),
          ...(workoutData.setCount !== undefined && { setCount: workoutData.setCount }),
          ...(workoutData.weight !== undefined && { weight: workoutData.weight }),
          ...(workoutData.repetitionCount !== undefined && { repetitionCount: workoutData.repetitionCount }),
          ...(workoutData.distance !== undefined && { distance: workoutData.distance }),
          ...(workoutData.durationSeconds !== undefined && { durationSeconds: workoutData.durationSeconds })
        }
      });
